			...
			<tbody>
				...
				while($registro=$resultado->fetch(PDO::FETCH_OBJ)){
					...
					<tr>
                        ...
                        <td><?php echo $registro->Permisos; ?></td>
						<td>
							<?php
							//if($_SESSION['Permisos']<=2){

								?>
								<span onclick="eliminarU(<?php echo $registro->ID; ?>)" class="btn-small red" style="margin-left: 1px;"><i class="material-icons ">delete</i></span>
								<?php
							//}
							?>
						</td>
