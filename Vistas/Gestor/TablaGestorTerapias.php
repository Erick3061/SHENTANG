					...
					<tr>
						...
						<td>
							...
							//if($_SESSION['Permisos']<=2){
								...
								?>
								<span href="#modal2te" onclick="obteberDatosTe(<?php echo $registro->ID; ?>)" class="btn-small blue modal-trigger" style="margin-left: 1px;"><i class="material-icons ">edit</i></span>
